  ...
  return (
    <aside className="w-64 h-screen bg-gray-100 shadow-md">
      <div className="flex justify-center mb-2 mt-4">
        <img src="src/assets/image/logo_DDM.png" alt="Logo da Empresa" className="h-20" />
      </div>

      <hr className="border-gray-300 mb-4" />

      <h2 className="text-gray-400 font-bold ml-8">PÁGINAS</h2>

      {/* Botão Lista de candidatos */}
      <button
        onClick={toggleSubList}
        className="flex items-center ml-6 mt-6 text-gray-600 hover:bg-gray-200 hover:text-blue-600 px-2 py-1 rounded"
      >
        <svg
      ...
      {/* Sub-lista */}
      {isSubListVisible && (
        <div className="ml-12 mt-2 space-y-2 text-gray-600">
          {[
            { name: 'Comercial', icon: (
            ...
            <button
              key={index}
              className="flex items-center w-full px-4 py-2 text-left rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-300"
            >
      ...
      <nav className="flex flex-col space-y-2 mt-4 ml-8">
        ...
        <div className="flex items-center">
          ...
          <button
            onClick={() => route('/dashboard/create-user')}
